...
import { refreshRankings } from './models.mjs';
import { configPatchFromRanking } from './rank.mjs';
...
export async function runModelsCommand(args, config) {
  ...
  if (doc.service) console.log(`  ${'servicio'.padEnd(10)} ${fmt(doc.service)}  (scout/scribe/security/merge)`);
